...
const SignupForm = () => {
  ...
  const handleSimulateApproval = async () => {
    ...
    const result = await authService.simulateAdminApproval(registeredEmail);
    toast({
  ...
  return (
    <>
      ...
      {/* Testing Dialog for Admin Approval */}
      <Dialog open={showApprovalDialog} onOpenChange={setShowApprovalDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Account Pending Approval</DialogTitle>
            <DialogDescription>
              Your account for {registeredEmail} has been created and is awaiting administrator approval.
            </DialogDescription>
          </DialogHeader>
          <p className="my-4 text-sm text-gray-600">
            In a production environment, an admin would approve your account through the AWS Cognito Admin UI or using Admin APIs.
          </p>
          <p className="mb-4 text-sm text-gray-600">
            For testing purposes, you can simulate this approval process by clicking the button below:
          </p>
          <DialogFooter>
            <Button 
